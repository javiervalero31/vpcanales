# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-07-16 14:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(default='Lideres', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateField(default=datetime.datetime.now, unique=True, verbose_name='')),
            ],
            options={
